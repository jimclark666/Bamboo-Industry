export const homeStyles = {
  ...
  metricPanel: 'rounded-md border border-neutral-300 bg-gradient-to-b from-white to-neutral-100/70',
  iconBadge:
    'inline-flex h-9 w-9 items-center justify-center rounded-md border border-neutral-300 bg-neutral-100 text-sm font-semibold text-neutral-700',
  valueTitle: 'text-[17px] font-semibold text-neutral-900',
  valueDesc: 'mt-3 text-sm leading-6 text-neutral-700'
} as const;
